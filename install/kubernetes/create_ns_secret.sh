...
do
    ...
    kubectl create secret docker-registry hubsecret --docker-server=https://mirror.iscas.ac.cn/ -n $namespace
...
# 移除 service 命名空间上的 istio-injection 标签，相当于:
# kubectl label namespace service istio-injection --remove
